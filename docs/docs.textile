...
Os elementos de hipervideo são descritos em um arquivo xml, determinado pela variável <tt>hipervideo.file</tt>. Este arquivo deve ser escrito conforme o exemplo abaixo:
